...
8. Note the root password shown at the end of the installation and process. You can now use it to login to the system via SSH.
...
Paste the following configuration template in the "Configuration file" text field:
